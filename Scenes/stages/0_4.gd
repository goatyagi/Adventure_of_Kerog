...
@onready var _animation: AnimationPlayer = $Animations/AnimationPlayer
...
func _on_pink_body_entered(_body):
	_animation.play("Pink")


func _on_green_body_entered(_body):
	_animation.play("Green")


func _on_yellow_body_entered(_body):
	_animation.play("Yellow")
