...
func _on_hit_box_area_entered(area: Area2D) -> void:
	...
	if area.is_in_group("green"):
		# SignalManager.on_green_flog_hit.emit()
...
func _on_buff_area_body_exited(body):
	if body.is_in_group("player_2"):
		is_boost = false
		body.unboosted()
